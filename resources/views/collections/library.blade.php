...
<div class="library-wrapper">
    ...
    <div class="library-grid">
        ...
        <a href="{{ $item->movie->getTrailerLink() }}" target="_blank" class="library-card {{ $item->getDaysUntilExpiration() <= 3 ? 'card-expiring' : '' }}" style="text-decoration: none; color: inherit;">
